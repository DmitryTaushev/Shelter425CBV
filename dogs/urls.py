...
from dogs.views import index_view, BreedsListView ,DogBreedListView, DogListView, DogCreateView, DogDetailView, \
...
urlpatterns = [
    ...
    path('dogs/',DogDeactivatedListView.as_view(),name='dogs_deactivated_list'),
